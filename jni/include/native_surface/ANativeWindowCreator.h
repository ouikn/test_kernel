...
public:
    ...
    static DisplayInfo GetDisplayInfo()
    {
        ...
        int32_t local_abs_x = (displayInfo.layerStackSpaceRect.width > displayInfo.layerStackSpaceRect.height ? 
                             displayInfo.layerStackSpaceRect.width : displayInfo.layerStackSpaceRect.height);
        int32_t local_abs_y = (displayInfo.layerStackSpaceRect.width < displayInfo.layerStackSpaceRect.height ? 
                             displayInfo.layerStackSpaceRect.width : displayInfo.layerStackSpaceRect.height);          
    ...
    static ANativeWindow *Create(const char *name, int32_t width = -1, int32_t height = -1, bool secure = true)
    {
        auto &surfaceComposerClient = GetComposerInstance();
        ...
        // 创建Surface
        auto surfaceControl = surfaceComposerClient.CreateSurface(name, width, height, secure);
